...
if __name__ == '__main__':
    # model_path = '/workspace/unilm/trocr/trocr-base-printed/pytorch_model.bin'
    model_path = '/workspace/unilm/trocr/trocr-base-printed/model.safetensors'
    jpg_path = "/workspace/unilm/trocr/7553.png"
    beam = 5
